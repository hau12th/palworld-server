...
export IS_RANDOMIZER_PAL_LEVEL_RANDOM=${IS_RANDOMIZER_PAL_LEVEL_RANDOM:-False}
...
export PAL_EGG_DEFAULT_HATCHING_TIME=${PAL_EGG_DEFAULT_HATCHING_TIME:-1.000000}
...
export CHARACTER_RECREATE_IN_HARDCORE=${CHARACTER_RECREATE_IN_HARDCORE:-False}
...
export ENABLE_FAST_TRAVEL_ONLY_BASE_CAMP=${ENABLE_FAST_TRAVEL_ONLY_BASE_CAMP:-False}
...
export SHOW_PLAYER_LIST=${SHOW_PLAYER_LIST:-False}
export CHAT_POST_LIMIT_PER_MINUTE=${CHAT_POST_LIMIT_PER_MINUTE:-30}
...
export EQUIPMENT_DURABILITY_DAMAGE_RATE=${EQUIPMENT_DURABILITY_DAMAGE_RATE:-1.000000}
export ITEM_CONTAINER_FORCE_MARK_DIRTY_INTERVAL=${ITEM_CONTAINER_FORCE_MARK_DIRTY_INTERVAL:-1.000000}
export ITEM_CORRUPTION_MULTIPLIER=${ITEM_CORRUPTION_MULTIPLIER:-1.000000}
export PHYSICS_ACTIVE_DROP_ITEM_MAX_NUM=${PHYSICS_ACTIVE_DROP_ITEM_MAX_NUM:--1}
export ALLOW_CLIENT_MOD=${ALLOW_CLIENT_MOD:-True}
export PLAYER_DATA_PAL_STORAGE_UPDATE_CHECK_TICK_INTERVAL=${PLAYER_DATA_PAL_STORAGE_UPDATE_CHECK_TICK_INTERVAL:-1.000000}
export LOG_FORMAT_TYPE=${LOG_FORMAT_TYPE:-Text}
export IS_SHOW_JOIN_LEFT_MESSAGE=${IS_SHOW_JOIN_LEFT_MESSAGE:-True}
export MONSTER_FARM_ACTION_SPEED_RATE=${MONSTER_FARM_ACTION_SPEED_RATE:-1.000000}
export DENY_TECHNOLOGY_LIST="${DENY_TECHNOLOGY_LIST:-""}"
export GUILD_REJOIN_COOLDOWN_MINUTES=${GUILD_REJOIN_COOLDOWN_MINUTES:-0}
export AUTO_TRANSFER_MASTER_CHECK_INTERVAL_SECONDS=${AUTO_TRANSFER_MASTER_CHECK_INTERVAL_SECONDS:-3600.000000}
export AUTO_TRANSFER_MASTER_THRESHOLD_DAYS=${AUTO_TRANSFER_MASTER_THRESHOLD_DAYS:-14}
export MAX_GUILDS_PER_FRAME=${MAX_GUILDS_PER_FRAME:-10}
export BLOCK_RESPAWN_TIME=${BLOCK_RESPAWN_TIME:-5.000000}
export RESPAWN_PENALTY_DURATION_THRESHOLD=${RESPAWN_PENALTY_DURATION_THRESHOLD:-0.000000}
export RESPAWN_PENALTY_TIME_SCALE=${RESPAWN_PENALTY_TIME_SCALE:-2.000000}
...
export VOICE_CHAT_MAX_VOLUME_DISTANCE=${VOICE_CHAT_MAX_VOLUME_DISTANCE:-3000.000000}
export VOICE_CHAT_ZERO_VOLUME_DISTANCE=${VOICE_CHAT_ZERO_VOLUME_DISTANCE:-15000.000000}
export ALLOW_ENHANCE_STAT_HEALTH=${ALLOW_ENHANCE_STAT_HEALTH:-True}
export ALLOW_ENHANCE_STAT_ATTACK=${ALLOW_ENHANCE_STAT_ATTACK:-True}
export ALLOW_ENHANCE_STAT_STAMINA=${ALLOW_ENHANCE_STAT_STAMINA:-True}
export ALLOW_ENHANCE_STAT_WEIGHT=${ALLOW_ENHANCE_STAT_WEIGHT:-True}
...
IS_RANDOMIZER_PAL_LEVEL_RANDOM = $IS_RANDOMIZER_PAL_LEVEL_RANDOM,
...
IS_PVP = $IS_PVP
HARDCORE = $HARDCORE
CHARACTER_RECREATE_IN_HARDCORE = $CHARACTER_RECREATE_IN_HARDCORE
PAL_LOST = $PAL_LOST
...
ENABLE_FAST_TRAVEL_ONLY_BASE_CAMP = $ENABLE_FAST_TRAVEL_ONLY_BASE_CAMP
...
EQUIPMENT_DURABILITY_DAMAGE_RATE = $EQUIPMENT_DURABILITY_DAMAGE_RATE
ITEM_CONTAINER_FORCE_MARK_DIRTY_INTERVAL = $ITEM_CONTAINER_FORCE_MARK_DIRTY_INTERVAL
ITEM_CORRUPTION_MULTIPLIER = $ITEM_CORRUPTION_MULTIPLIER
PHYSICS_ACTIVE_DROP_ITEM_MAX_NUM = $PHYSICS_ACTIVE_DROP_ITEM_MAX_NUM
ALLOW_CLIENT_MOD = $ALLOW_CLIENT_MOD
PLAYER_DATA_PAL_STORAGE_UPDATE_CHECK_TICK_INTERVAL = $PLAYER_DATA_PAL_STORAGE_UPDATE_CHECK_TICK_INTERVAL
LOG_FORMAT_TYPE = $LOG_FORMAT_TYPE
IS_SHOW_JOIN_LEFT_MESSAGE = $IS_SHOW_JOIN_LEFT_MESSAGE
MONSTER_FARM_ACTION_SPEED_RATE = $MONSTER_FARM_ACTION_SPEED_RATE
DENY_TECHNOLOGY_LIST = $DENY_TECHNOLOGY_LIST
GUILD_REJOIN_COOLDOWN_MINUTES = $GUILD_REJOIN_COOLDOWN_MINUTES
AUTO_TRANSFER_MASTER_CHECK_INTERVAL_SECONDS = $AUTO_TRANSFER_MASTER_CHECK_INTERVAL_SECONDS
AUTO_TRANSFER_MASTER_THRESHOLD_DAYS = $AUTO_TRANSFER_MASTER_THRESHOLD_DAYS
MAX_GUILDS_PER_FRAME = $MAX_GUILDS_PER_FRAME
BLOCK_RESPAWN_TIME = $BLOCK_RESPAWN_TIME
RESPAWN_PENALTY_DURATION_THRESHOLD = $RESPAWN_PENALTY_DURATION_THRESHOLD
RESPAWN_PENALTY_TIME_SCALE = $RESPAWN_PENALTY_TIME_SCALE
DISPLAY_PVP_ITEM_NUM_ON_WORLD_MAP_BASE_CAMP = $DISPLAY_PVP_ITEM_NUM_ON_WORLD_MAP_BASE_CAMP
DISPLAY_PVP_ITEM_NUM_ON_WORLD_MAP_PLAYER = $DISPLAY_PVP_ITEM_NUM_ON_WORLD_MAP_PLAYER
ADDITIONAL_DROP_ITEM_WHEN_PLAYER_KILLING_IN_PVP_MODE = $ADDITIONAL_DROP_ITEM_WHEN_PLAYER_KILLING_IN_PVP_MODE
ADDITIONAL_DROP_ITEM_NUM_WHEN_PLAYER_KILLING_IN_PVP_MODE = $ADDITIONAL_DROP_ITEM_NUM_WHEN_PLAYER_KILLING_IN_PVP_MODE
ADDITIONAL_DROP_ITEM_WHEN_PLAYER_KILLING_IN_PVP_MODE_ENABLED = $ADDITIONAL_DROP_ITEM_WHEN_PLAYER_KILLING_IN_PVP_MODE_ENABLED
ENABLE_VOICE_CHAT = $ENABLE_VOICE_CHAT
VOICE_CHAT_MAX_VOLUME_DISTANCE = $VOICE_CHAT_MAX_VOLUME_DISTANCE
VOICE_CHAT_ZERO_VOLUME_DISTANCE = $VOICE_CHAT_ZERO_VOLUME_DISTANCE
ALLOW_ENHANCE_STAT_HEALTH = $ALLOW_ENHANCE_STAT_HEALTH
ALLOW_ENHANCE_STAT_ATTACK = $ALLOW_ENHANCE_STAT_ATTACK
ALLOW_ENHANCE_STAT_STAMINA = $ALLOW_ENHANCE_STAT_STAMINA
ALLOW_ENHANCE_STAT_WEIGHT = $ALLOW_ENHANCE_STAT_WEIGHT
ALLOW_ENHANCE_STAT_WORK_SPEED = $ALLOW_ENHANCE_STAT_WORK_SPEED
ENABLE_BUILDING_PLAYER_UID_DISPLAY = $ENABLE_BUILDING_PLAYER_UID_DISPLAY
BUILDING_NAME_DISPLAY_CACHE_TTL_SECONDS = $BUILDING_NAME_DISPLAY_CACHE_TTL_SECONDS
====Debug====
EOF
fi
